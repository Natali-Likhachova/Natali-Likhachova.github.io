...
if ( ! function_exists( 'akad_setup' ) ) :
	...
	function akad_setup() {
		...
		register_nav_menus( array(
            'header-menu' => esc_html__( 'Header Menu', 'akad' ),
            'footer-menu' => esc_html__( 'Footer Menu', 'akad' ),
		) );
...
//        include ( get_template_directory() . '/inc/custom-post-type-information.php' );//ошибка, продолжение в файле custom-post-type-information.php
...
function akad_scripts() {
    ...
    wp_enqueue_style( 'akad-google-fonts1', 'https://fonts.googleapis.com/css?family=Montserrat:100i,300,400,500,600,700,800,900|Open+Sans:300,400,600,700,800', array(), null);
    wp_enqueue_style( 'akad-bootstrap', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css' , array(), '4.7.0');
    wp_enqueue_style( 'akad-casual', get_template_directory_uri(). '/css/import.css', array(), null);
